...
if __name__ == "__main__":
    ...
    # TEST(wsgwak)
    cross_role_hyper_orig = []
    cross_role_laplacian_orig = []
    ...
    for i in range(args.time_steps):
        ...
        train_hypergraph += [Role_hyper.laplacian().to(device)]
        if i > 0:
            ...
            ### TEST(wsgwak)
            # cross_role_hyper_orig += [Cross_role_hypergraph]
            ...
            cross_role_hyper += [Cross_role_hypergraph.to(device)]
            cross_role_laplacian += [previous_role_hypergraph.laplacian().to(device)]
    ...
    for epoch in range(args.epochs):
        ...
        for idx,feed_dict in enumerate(dataloader):
            if idx == 0:
                # print(cross_role_hyper)
                print(cross_role_hyper_orig)
                continue
