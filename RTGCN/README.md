# Representation Learning of Temporal Graphs with Structural Roles based GCN Expert
## 1. Environment
...
## 4. Acknowledgements
- This code is based on the works available at RTGCN (https://github.com/trytodoit227/RTGCN-new)
